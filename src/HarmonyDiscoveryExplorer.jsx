    ...
    >
      ...
      {referenceKey && (
        <text
          ...
          fontSize={referenceLabel.length > 2 ? 6.5 : 7.5}
          fontWeight="600"
          fill="#1B1D2A"
          opacity="0.72"
          pointerEvents="none"
...
async function handleSaveProgression() {
  ...
  const analyzedCurrentLabel = useMemo(
    () => labelForNotes(currentNotes, key.flats),
    [currentNotes, key],
  );
  const negativeReference = useMemo(
